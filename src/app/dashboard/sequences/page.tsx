			...
			<div className="flex flex-1 flex-col gap-3 text-sm lg:flex-row lg:items-center lg:justify-end">
				<div>
					<span className="font-medium text-foreground">
						{selectedIds.size > 0 ? `${selectedIds.size} sequence(s) selected` : 'No sequences selected'}
					</span>
				...
				<div className="flex flex-wrap justify-end gap-2">
					<Button
						...
						disabled={selectedIds.size === 0 || activateMutation.isPending || !hasActivatableSequences}
			...
			{isLoading ? (
				...
				<div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
					{filteredSequences.map((sequence: any) => (
						<Card key={sequence.id} className="relative rounded-[24px] border border-slate-200 shadow-sm">
							...
							<CardContent className="pl-12">
								...
								<div className="flex gap-2">
									<Link href={`/dashboard/sequences/${sequence.id}`} className="flex-1">
